    <h3>This is the 'section-searchresult.php' file</h3>
    <main>
        <div class="page-wrap">
            <div class="container">
            ...
            <?php
                ...
                echo "<p style='color:red'> Ulac kra s yisem n <span style='font-size:2rem; background-color:grey; color:white'> \" ".get_search_query()." \" </span></p>";
            endif;
            ?>
                </article>
